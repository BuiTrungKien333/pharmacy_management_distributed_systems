...
public class ToolBarAccentColor extends JPanel {
	...
	private final String[] accentColorKeys = { "App.accent.default", "App.accent.blue", "App.accent.purple",
	...
	private class AccentColorIcon extends FlatAbstractIcon {
		...
		protected void paintIcon(Component c, Graphics2D g) {
			...
			if (accColor == null) {
				...
				accColor = FlatLaf.isLafDark() ? ColorFunctions.shade(accColor, 0.5f)
